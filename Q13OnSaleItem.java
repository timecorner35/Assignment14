...
public class Q13OnSaleItem extends Q13Item {
    /**
     ...
     * - assigns discount
     */
    public Q13OnSaleItem(String name, int quantity, int catalogNumber, double price, double discount) {
        super(name,catalogNumber,quantity,price);
        this.discount = discount;
        setPrice(price*(100-discount));
